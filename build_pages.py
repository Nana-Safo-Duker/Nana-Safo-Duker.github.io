...
def page(rel_path: str, title: str, heading: str, body: str, description: str = "", page_class: str = "") -> None:
    ...
    logo = f"{prefix}images/genehus-mark.png?v=20260811c"
    logo_full = f"{prefix}images/genehus-logo.png?v=20260811c"
    css = f"{prefix}css/site.css?v=20260811c"
    js = f"{prefix}js/nav.js?v=20260811c"
...
<div id="main" role="main">
  <div class="article-author-side">
    <div itemscope itemtype="https://schema.org/Person">
      <img src="{photo}?v=20260811c" class="bio-photo" alt="{NAME} bio photo" width="150" height="150">
      ...
      <p class="founder-statement">
        ...
        <span class="founder-statement__brand">
          <a href="https://genehus.bio" target="_blank" rel="noopener" class="founder-statement__brand-link">
            <img src="./images/genehus-logo.png?v=20260811c" alt="GeneHus" class="genehus-logo-full">
          </a>
        </span>
...
CONTACT = """
      <p class="contact-links">
        ...
        <a href="https://genehus.bio" target="_blank" rel="noopener" class="author-social--genehus"><img src="../images/genehus-mark.png?v=20260811c" alt="GeneHus" class="genehus-logo-icon"> GeneHus</a>
