...
LINKEDIN = "https://www.linkedin.com/in/nana-safo-duker/"
...
def page(rel_path: str, title: str, heading: str, body: str, description: str = "", page_class: str = "") -> None:
    ...
    logo = f"{prefix}images/genehus-mark.png?v=20260817f"
    logo_full = f"{prefix}images/genehus-logo.png?v=20260817f"
    css = f"{prefix}css/site.css?v=20260817f"
    js = f"{prefix}js/nav.js?v=20260817f"
...
<div id="main" role="main">
  <div class="article-author-side">
    <div itemscope itemtype="https://schema.org/Person">
      <img src="{photo}?v=20260817f" class="bio-photo" alt="{NAME} bio photo" width="150" height="150">
      ...
      <p class="founder-statement">
        ...
        <span class="founder-statement__brand">
          <a href="https://genehus.bio" target="_blank" rel="noopener" class="founder-statement__brand-link">
            <img src="./images/genehus-logo.png?v=20260817f" alt="GeneHus" class="genehus-logo-full">
          </a>
        </span>
...
BLOGS = """
      <div class="blogs-grid">
        ...
        <article class="blog-card">
          <h3>The Real Climate Debate Isn't About AI: It's About Governance</h3>
          <p>
        ...
        <article class="blog-card">
          <h3>From Satellites to Predictions: Machine Learning for Malaria Outbreak Forecasting</h3>
          <p>
        ...
        <article class="blog-card">
          <h3>Every AI Tool Is Also a Potential Weapon</h3>
          <p>
        ...
        <article class="blog-card">
          <h3>The Politics of Climate Change: Why Justice Can't Be Optional</h3>
          <p>
        ...
        <article class="blog-card">
          <h3>Graph Neural Networks for Weather Forecasting: A Critical Analysis of GraphCast</h3>
          <p>
        ...
        <article class="blog-card">
          <h3>AI Is Moving Faster Than Governments Can Respond</h3>
          <p>
        ...
        <article class="blog-card">
          <h3>Can AI Fight Climate Change Without Worsening It?</h3>
          <p>
        ...
        <article class="blog-card">
          <h3>Wearable Sensors for Brain Disorder Detection Through Eye Movements: A Comprehensive Research Review</h3>
          <p>
...
CONTACT = """
      <p class="contact-links">
        ...
        <a href="https://genehus.bio" target="_blank" rel="noopener" class="author-social--genehus"><img src="../images/genehus-mark.png?v=20260817f" alt="GeneHus" class="genehus-logo-icon"> GeneHus</a>
